...
当前已完成第一个环节：PRD 制作。支持 Markdown 直接编辑、可编辑和全屏的实时预览、双向内容同步、可收起的 AI 对话助手根据主题或说明生成完整 PRD、撤销 AI 生成、配置 OpenAI-compatible 大模型或 HTTP/HTTPS 自定义中转站、自动保存、默认脱敏案例，以及复制和下载 Markdown。
